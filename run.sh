...
if [ "$COMMAND" = "dataset_from_mdp" ]; then
    ...
    uv run python -m src.train \
        --environment="LunarLander-v3" \
        --algorithm="jepa" \
        --dataset="datasets/LunarLander-v3/state-action/dataset_2026-08-23-19-16-47.pt" \
        --hyperparameters="hyperparameters/jepa_lunar_lander.json" \
        --normalise-obs \
        -dt="sa" -l -s
    ...
    uv run python -m src.datasets.dataset_from_encoder \
        --environment="LunarLander-v3" \
        --dataset="datasets/LunarLander-v3/state-action/dataset_2026-08-23-19-16-47.pt" \
        --model="saved_networks/jepa/model/LunarLander-v3/LunarLander-v3@2026-08-24-19-21-32/model_149.pt"
elif [ "$COMMAND" = "train_decoder" ]; then
    uv run python -m src.train \
        --environment="LunarLander-v3" \
        --algorithm="jepa_decoder" \
        --dataset="datasets/LunarLander-v3/decoder/dataset_2026-08-24-19-44-07.pt" \
    ...
    uv run python -m src.visualise \
        --environment="LunarLander-v3" \
        --model="saved_networks/jepa/model/LunarLander-v3/LunarLander-v3@2026-08-24-19-21-32/model_149.pt" \
        --decoder="saved_networks/jepa/decoder/LunarLander-v3/LunarLander-v3@2026-08-24-19-44-46/decoder_89.pt" \
        --policy="categorical" \
        --weights="/home/kieran/coding-projects/My-RL-Impl/saved_policies/LunarLander-v3/LunarLander-v3@2026-07-12-17-18-42/policy_1999999.pth" \
        --sync
